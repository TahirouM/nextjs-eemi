          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="border-b border-rule text-left text-xs uppercase tracking-wide text-ink-soft">
                <tr>
                  <th scope="col" className="p-4">{t("colMember")}</th>
                  <th scope="col" className="p-4">{t("colRole")}</th>
                  <th scope="col" className="p-4">{t("colMembership")}</th>
                  <th scope="col" className="p-4">{t("colRoom")}</th>
                  <th scope="col" className="p-4">{t("colSessions")}</th>
                  <th scope="col" className="p-4">{t("colSignedUp")}</th>
                </tr>
              </thead>
